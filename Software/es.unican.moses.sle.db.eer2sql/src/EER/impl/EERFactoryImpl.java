...
public class EERFactoryImpl extends EFactoryImpl implements EERFactory {
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			...
			case EERPackage.UNBOUNDED_NATURAL:
				return createUnboundedNaturalFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			...
			case EERPackage.UNBOUNDED_NATURAL:
				return convertUnboundedNaturalToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public UnboundedNatural createUnboundedNaturalFromString(EDataType eDataType, String initialValue) {
		return (UnboundedNatural)super.createFromString(eDataType, initialValue);
	}
	 ...
	 * @generated
	 */
	public String convertUnboundedNaturalToString(EDataType eDataType, Object instanceValue) {
