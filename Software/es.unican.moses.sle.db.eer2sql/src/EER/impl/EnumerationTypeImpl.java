 ...
 * <ul>
 *   <li>{@link EER.impl.EnumerationTypeImpl#getLiterals <em>Literals</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnumerationTypeImpl extends DomainImpl implements EnumerationType {
	...
	protected EClass eStaticClass() {
		return EERPackage.Literals.ENUMERATION_TYPE;
	}
	...
	public EList<EnumeratedLiteral> getLiterals() {
		if (literals == null) {
			literals = new EObjectContainmentEList<EnumeratedLiteral>(EnumeratedLiteral.class, this, EERPackage.ENUMERATION_TYPE__LITERALS);
		}
		return literals;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EERPackage.ENUMERATION_TYPE__LITERALS:
