...
/**
 * This is the item provider adapter for a {@link EER.Attribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EERPackage.Literals.ATTRIBUTE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addNullablePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_nullable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_nullable_feature", "_UI_Attribute_type"),
				 EERPackage.Literals.ATTRIBUTE__NULLABLE,
				 true,
				 false,
				 false,
