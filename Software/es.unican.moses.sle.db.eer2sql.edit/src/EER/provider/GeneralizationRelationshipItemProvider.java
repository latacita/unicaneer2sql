...
/**
 * This is the item provider adapter for a {@link EER.GeneralizationRelationship} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GeneralizationRelationshipItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GeneralizationRelationship_relationship_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GeneralizationRelationship_relationship_feature", "_UI_GeneralizationRelationship_type"),
				 EERPackage.Literals.GENERALIZATION_RELATIONSHIP__RELATIONSHIP,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		return getString("_UI_GeneralizationRelationship_type");
	}
