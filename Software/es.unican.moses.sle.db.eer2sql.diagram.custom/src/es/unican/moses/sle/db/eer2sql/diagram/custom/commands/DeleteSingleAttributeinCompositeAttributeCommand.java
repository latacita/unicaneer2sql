...
/**
 * Class DeleteSingleAttributeinCompositeAttributeCommand.</br>
 * 
 * @author Adrian Fdez San Marcos
 * @version 16-06-2011
 */
public class DeleteSingleAttributeinCompositeAttributeCommand extends AbstractTransactionalCommand{
		
	private CompositeAttribute element;
	private int index;
	
	public DeleteSingleAttributeinCompositeAttributeCommand(
...
} // DeleteSingleAttributeinCompositeAttributeCommand
