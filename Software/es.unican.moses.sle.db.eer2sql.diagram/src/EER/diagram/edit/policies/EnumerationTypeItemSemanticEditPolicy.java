...
import EER.diagram.edit.commands.EnumeratedLiteralReorientCommand;
 ...
 * @generated
 */
public class EnumerationTypeItemSemanticEditPolicy extends
	...
	public EnumerationTypeItemSemanticEditPolicy() {
		super(Eer2sqlElementTypes.EnumerationType_2002);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (Eer2sqlVisualIDRegistry.getVisualID(incomingLink) == SingleAttributeEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (Eer2sqlVisualIDRegistry.getVisualID(outgoingLink) == EnumeratedLiteralEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (Eer2sqlElementTypes.EnumeratedLiteral_4010 == req.getElementType()) {
	...
	protected Command getReorientRelationshipCommand(
		...
		case EnumeratedLiteralEditPart.VISUAL_ID:
			return getGEFWrapper(new EnumeratedLiteralReorientCommand(req));
		}
