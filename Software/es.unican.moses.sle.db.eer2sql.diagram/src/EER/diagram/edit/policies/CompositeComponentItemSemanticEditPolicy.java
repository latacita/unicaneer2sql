...
public class CompositeComponentItemSemanticEditPolicy extends
	...
	public CompositeComponentItemSemanticEditPolicy() {
		super(EERmodelElementTypes.CompositeComponent_2013);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (EERmodelVisualIDRegistry.getVisualID(outgoingLink) == AggregationParticipantEditPart.VISUAL_ID) {
			...
			if (EERmodelVisualIDRegistry.getVisualID(outgoingLink) == AggregationParticipant2EditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						outgoingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (EERmodelElementTypes.AggregationParticipant_4003 == req
				.getElementType()) {
