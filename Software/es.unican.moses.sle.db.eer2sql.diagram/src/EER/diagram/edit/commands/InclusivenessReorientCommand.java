 ...
 * @generated
 */
public class InclusivenessReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public InclusivenessReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Inclusiveness) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return EERmodelBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistInclusiveness_4011(container, getLink(),
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Participant container = (Participant) getLink().eContainer();
		return EERmodelBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistInclusiveness_4011(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected Inclusiveness getLink() {
		return (Inclusiveness) getElementToEdit();
	}
