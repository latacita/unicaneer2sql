 ...
 * @generated
 */
public class GeneralizationParentCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public GeneralizationParentCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (target != null
				&& false == target instanceof SpecializationRelationship) {
			return false;
		}
		if (getSource() == null) {
		...
		return Eer2sqlBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateGeneralizationParent_4012(getSource(), getTarget());
	}
	 ...
	 * @generated
	 */
	protected SpecializationRelationship getTarget() {
		return (SpecializationRelationship) target;
	}
}
