...
public class PrimitiveTypeEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PrimitiveTypeNameEditPart) {
			((PrimitiveTypeNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePrimitiveTypeName());
			return true;
		}
		return false;
	}
	 ...
	 * @generated
	 */
	public class PrimitiveTypeFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigurePrimitiveTypeName;
		...
		private void createContents() {
			...
			fFigurePrimitiveTypeName = new WrappingLabel();
			fFigurePrimitiveTypeName.setText("<<...>>");

			fFigurePrimitiveTypeName.setFont(FFIGUREPRIMITIVETYPENAME_FONT);

			this.add(fFigurePrimitiveTypeName);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigurePrimitiveTypeName() {
			return fFigurePrimitiveTypeName;
		}
	 ...
	 * @generated
	 */
	static final Font FFIGUREPRIMITIVETYPENAME_FONT = new Font(
