...
public class AggregationParticipantEditPart extends ConnectionNodeEditPart
	...
	protected Connection createConnectionFigure() {
		return new LineAggregationFigure();
	}

	/**
	 * @generated
	 */
	public LineAggregationFigure getPrimaryShape() {
		return (LineAggregationFigure) getFigure();
	}

	/**
	 * @generated
	 */
	public class LineAggregationFigure extends PolylineConnectionEx {

		/**
		 * @generated
		 */
		public LineAggregationFigure() {
