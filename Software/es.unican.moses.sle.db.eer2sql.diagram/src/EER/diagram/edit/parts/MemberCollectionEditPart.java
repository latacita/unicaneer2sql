...
public class MemberCollectionEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof MemberCollectionNameEditPart) {
			((MemberCollectionNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureMemberCollectionNameFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof EER.diagram.edit.parts.MemberCollectionEditPart) {
			types.add(Eer2sqlElementTypes.AggregationParticipant_4009);
		}
	 ...
	 * @generated
	 */
	public class MemberCollectionFigure extends RectangleFigure {
