...
public class ParticipantEditPart extends ConnectionNodeEditPart implements
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ParticipantLowerBoundUpperBoundEditPart) {
			((ParticipantLowerBoundUpperBoundEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureCardinality());
			return true;
		}
		return false;
	}
	...
	public class SimpleLineFigure extends PolylineConnectionEx {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureCardinality;
		/**
		 * @generated
		 */
		...
		private void createContents() {
			...
			fFigureCardinality = new WrappingLabel();
			fFigureCardinality.setText("");

			this.add(fFigureCardinality);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureCardinality() {
			return fFigureCardinality;
		}
