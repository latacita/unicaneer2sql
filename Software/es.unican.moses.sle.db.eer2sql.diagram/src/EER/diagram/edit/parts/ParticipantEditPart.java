...
public class ParticipantEditPart extends ConnectionNodeEditPart implements
	...
	protected Connection createConnectionFigure() {
		return new ParticipantTargetFigure();
	}

	/**
	 * @generated
	 */
	public ParticipantTargetFigure getPrimaryShape() {
		return (ParticipantTargetFigure) getFigure();
	}

	/**
	 * @generated
	 */
	public class ParticipantTargetFigure extends PolylineConnectionEx {

		/**
		 * @generated
		 */
		public ParticipantTargetFigure() {
