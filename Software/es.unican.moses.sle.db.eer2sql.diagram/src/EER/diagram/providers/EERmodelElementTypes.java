...
public class EERmodelElementTypes {
	 ...
	 * @generated
	 */
	public static final IElementType AggregationParticipant_4006 = getElementType("es.unican.moses.sle.db.eer2sql.diagram.AggregationParticipant_4006"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(AggregationParticipant_4006,
					EERPackage.eINSTANCE.getAggregationParticipant());
	...
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(AggregationParticipant_4006);
	...
	public static IElementType getElementType(int visualID) {
		...
		case AggregationParticipant2EditPart.VISUAL_ID:
			return AggregationParticipant_4006;
