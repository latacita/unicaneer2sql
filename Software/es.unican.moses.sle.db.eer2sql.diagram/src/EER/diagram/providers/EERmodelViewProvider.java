...
public class EERmodelViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		return EntityEditPart.VISUAL_ID == visualID
				|| WeakEntityEditPart.VISUAL_ID == visualID
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case AggregationParticipant2EditPart.VISUAL_ID:
			return createAggregationParticipant_4003(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case SpecializationRelationshipEditPart.VISUAL_ID:
			return createSpecializationRelationship_4004(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
	 ...
	 * @generated
	 */
	public Edge createAggregationParticipant_4003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	 ...
	 * @generated
	 */
	public Edge createSpecializationRelationship_4004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
