 ...
 * @generated
 */
public class Eer2sqlDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public Eer2sqlDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof Eer2sqlDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((Eer2sqlDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new Eer2sqlDomainNavigatorItem((EObject) objects[i],
