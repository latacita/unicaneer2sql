 ...
 * @generated
 */
public class Eer2sqlInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new Eer2sqlNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				ProjectEditPart.MODEL_ID));
		Eer2sqlDiagramEditorUtil.runWizard(getShell(), wizard,
