...
public class EERmodelPaletteFactory {
	...
	public void fillPalette(PaletteRoot paletteRoot) {
		...
		paletteRoot.add(createDataTypes5Group());
	}
	...
	private PaletteContainer createLinks3Group() {
		...
		paletteContainer.add(createLineAggregation2CreationTool());
		paletteContainer.add(createLineGeneralizationParent3CreationTool());
		paletteContainer.add(createLineGeneralizationChilds4CreationTool());
		return paletteContainer;
	}
	 ...
	 * @generated
	 */
	private PaletteContainer createDataTypes5Group() {
		PaletteDrawer paletteContainer = new PaletteDrawer(
				Messages.DataTypes5Group_title);
		paletteContainer.setId("createDataTypes5Group"); //$NON-NLS-1$
	...
	private ToolEntry createAggregation4CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				Messages.Aggregation4CreationTool_title, null,
				Collections
						.singletonList(EERmodelElementTypes.Aggregation_2017));
		entry.setId("createAggregation4CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(EERmodelElementTypes
				.getImageDescriptor(EERmodelElementTypes.Aggregation_2017));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	 ...
	 * @generated
	 */
	private ToolEntry createLineAggregation2CreationTool() {
		LinkToolEntry entry = new LinkToolEntry(
				Messages.LineAggregation2CreationTool_title,
				null,
				Collections
						.singletonList(EERmodelElementTypes.AggregationParticipant_4002));
		entry.setId("createLineAggregation2CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(EERmodelElementTypes
	 ...
	 * @generated
	 */
	private ToolEntry createLineGeneralizationParent3CreationTool() {
		LinkToolEntry entry = new LinkToolEntry(
				Messages.LineGeneralizationParent3CreationTool_title,
				null,
				Collections
						.singletonList(EERmodelElementTypes.SpecializationRelationship_4007));
		entry.setId("createLineGeneralizationParent3CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(EERmodelElementTypes
	 ...
	 * @generated
	 */
	private ToolEntry createLineGeneralizationChilds4CreationTool() {
		LinkToolEntry entry = new LinkToolEntry(
				Messages.LineGeneralizationChilds4CreationTool_title,
				null,
				Collections
						.singletonList(EERmodelElementTypes.GeneralizationRelationship_4005));
		entry.setId("createLineGeneralizationChilds4CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(EERmodelElementTypes
