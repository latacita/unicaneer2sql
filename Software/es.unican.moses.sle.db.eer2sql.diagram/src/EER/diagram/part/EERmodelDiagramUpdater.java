...
public class EERmodelDiagramUpdater {
	...
	public static List<EERmodelNodeDescriptor> getSemanticChildren(View view) {
		...
		case CompositeAttributeCompositeAttributeCompartment2EditPart.VISUAL_ID:
			return getCompositeAttributeCompositeAttributeCompartment_7005SemanticChildren(view);
		...
		case CompositeAttributeCompositeAttributeCompartmentEditPart.VISUAL_ID:
			return getCompositeAttributeCompositeAttributeCompartment_7004SemanticChildren(view);
	 ...
	 * @generated
	 */
	public static List<EERmodelNodeDescriptor> getCompositeAttributeCompositeAttributeCompartment_7005SemanticChildren(
			View view) {
		if (false == view.eContainer() instanceof View) {
			return Collections.emptyList();
		}
		...
		CompositeAttribute modelElement = (CompositeAttribute) containerView
				.getElement();
		LinkedList<EERmodelNodeDescriptor> result = new LinkedList<EERmodelNodeDescriptor>();
		for (Iterator<?> it = modelElement.getSinglesAttributes().iterator(); it
				.hasNext();) {
			Attribute childElement = (Attribute) it.next();
			int visualID = EERmodelVisualIDRegistry.getNodeVisualID(view,
					childElement);
			if (visualID == SingleAttribute4EditPart.VISUAL_ID) {
				result.add(new EERmodelNodeDescriptor(childElement, visualID));
				continue;
			}
		}
	 ...
	 * @generated
	 */
	public static List<EERmodelNodeDescriptor> getCompositeAttributeCompositeAttributeCompartment_7004SemanticChildren(
			View view) {
		if (false == view.eContainer() instanceof View) {
			return Collections.emptyList();
		}
		...
		for (Iterator<?> it = modelElement.getSinglesAttributes().iterator(); it
			...
			int visualID = EERmodelVisualIDRegistry.getNodeVisualID(view,
					childElement);
			if (visualID == SingleAttribute5EditPart.VISUAL_ID) {
				result.add(new EERmodelNodeDescriptor(childElement, visualID));
				continue;
			}
		}
	...
	public static List<EERmodelLinkDescriptor> getContainedLinks(View view) {
		...
		case AggregationEditPart.VISUAL_ID:
			return getAggregation_2017ContainedLinks(view);
		...
		case SingleAttribute4EditPart.VISUAL_ID:
			return getSingleAttribute_3012ContainedLinks(view);
		...
		case SingleAttribute5EditPart.VISUAL_ID:
			return getSingleAttribute_3013ContainedLinks(view);
	...
	public static List<EERmodelLinkDescriptor> getIncomingLinks(View view) {
		...
		case AggregationEditPart.VISUAL_ID:
			return getAggregation_2017IncomingLinks(view);
		case CandidateKeyEditPart.VISUAL_ID:
		...
		case SingleAttribute4EditPart.VISUAL_ID:
			return getSingleAttribute_3012IncomingLinks(view);
		case CandidateKey2EditPart.VISUAL_ID:
		...
		case SingleAttribute5EditPart.VISUAL_ID:
			return getSingleAttribute_3013IncomingLinks(view);
		case SingleAttribute3EditPart.VISUAL_ID:
	...
	public static List<EERmodelLinkDescriptor> getOutgoingLinks(View view) {
		...
		case AggregationEditPart.VISUAL_ID:
			return getAggregation_2017OutgoingLinks(view);
		case CandidateKeyEditPart.VISUAL_ID:
		...
		case SingleAttribute4EditPart.VISUAL_ID:
			return getSingleAttribute_3012OutgoingLinks(view);
		case CandidateKey2EditPart.VISUAL_ID:
		...
		case SingleAttribute5EditPart.VISUAL_ID:
			return getSingleAttribute_3013OutgoingLinks(view);
		case SingleAttribute3EditPart.VISUAL_ID:
	 ...
	 * @generated
	 */
	public static List<EERmodelLinkDescriptor> getAggregation_2017ContainedLinks(
			View view) {
	 ...
	 * @generated
	 */
	public static List<EERmodelLinkDescriptor> getSingleAttribute_3012ContainedLinks(
			View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<EERmodelLinkDescriptor> getSingleAttribute_3013ContainedLinks(
			View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<EERmodelLinkDescriptor> getAggregation_2017IncomingLinks(
			View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<EERmodelLinkDescriptor> getSingleAttribute_3012IncomingLinks(
			View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<EERmodelLinkDescriptor> getSingleAttribute_3013IncomingLinks(
			View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<EERmodelLinkDescriptor> getAggregation_2017OutgoingLinks(
			View view) {
		Aggregation modelElement = (Aggregation) view.getElement();
		LinkedList<EERmodelLinkDescriptor> result = new LinkedList<EERmodelLinkDescriptor>();
	 ...
	 * @generated
	 */
	public static List<EERmodelLinkDescriptor> getSingleAttribute_3012OutgoingLinks(
			View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<EERmodelLinkDescriptor> getSingleAttribute_3013OutgoingLinks(
			View view) {
		return Collections.emptyList();
	}
