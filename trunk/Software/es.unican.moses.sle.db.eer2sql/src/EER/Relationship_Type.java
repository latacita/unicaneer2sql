 ...
 * @generated
 */
public enum Relationship_Type implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	private static final Relationship_Type[] VALUES_ARRAY =
	 ...
	 * @generated
	 */
	public static final List<Relationship_Type> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	public static Relationship_Type get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Relationship_Type result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static Relationship_Type getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Relationship_Type result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static Relationship_Type get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private Relationship_Type(int value, String name, String literal) {
		this.value = value;
		this.name = name;
