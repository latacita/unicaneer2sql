 ...
 * @generated
 */
public enum Generalization_Type implements Enumerator {
	/**
	 ...
	 * @ordered
	 */
	TOTAL_OVERLAPPING(0, "Total_Overlapping", "Total_Overlapping"),
	 ...
	 * @ordered
	 */
	TOTAL_DISJOINT(1, "Total_Disjoint", "Total_Disjoint"),
	 ...
	 * @ordered
	 */
	PARTIAL_OVERLAPPING(2, "Partial_Overlapping", "Partial_Overlapping"),
	 ...
	 * @ordered
	 */
	PARTIAL_DISJOINT(3, "Partial_Disjoint", "Partial_Disjoint");
	 ...
	 * @model name="Partial_Overlapping"
	 * @generated
	 * @ordered
	 */
	 ...
	 * @generated
	 */
	private static final Generalization_Type[] VALUES_ARRAY =
		new Generalization_Type[] {
			TOTAL_OVERLAPPING,
			TOTAL_DISJOINT,
			PARTIAL_OVERLAPPING,
			PARTIAL_DISJOINT,
	 ...
	 * @generated
	 */
	public static final List<Generalization_Type> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	public static Generalization_Type get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Generalization_Type result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static Generalization_Type getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Generalization_Type result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static Generalization_Type get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private Generalization_Type(int value, String name, String literal) {
		this.value = value;
		this.name = name;
