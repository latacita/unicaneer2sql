 ...
 * <!-- end-user-doc -->
 * @see EER.EERPackage#getDependency_Type()
 * @model
 * @generated
 */
public enum Dependency_Type implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	private static final Dependency_Type[] VALUES_ARRAY =
		new Dependency_Type[] {
			ID,
			E,
		};
	 ...
	 * @generated
	 */
	public static final List<Dependency_Type> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	public static Dependency_Type get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Dependency_Type result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static Dependency_Type getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Dependency_Type result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static Dependency_Type get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private Dependency_Type(int value, String name, String literal) {
		this.value = value;
		this.name = name;
