 ...
 * @generated
 */
public class EERmodelDiagramEditorUtil {
	...
	public static Resource openModel(Shell shell, String description,
		...
		try {
			...
			MessageDialog
					.openError(
							shell,
							Messages.EERmodelDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
							NLS.bind(
									Messages.EERmodelDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
									fileName));
		}
		return resource;
	}
	...
	public static void runWizard(Shell shell, Wizard wizard, String settingsKey) {
		IDialogSettings pluginDialogSettings = EERmodelDiagramEditorPlugin
	...
	public static Resource createDiagram(URI diagramURI, URI modelURI,
		...
		progressMonitor
				.beginTask(
						Messages.EERmodelDiagramEditorUtil_CreateDiagramProgressTask,
						3);
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
				editingDomain,
				Messages.EERmodelDiagramEditorUtil_CreateDiagramCommandLabel,
			...
			protected CommandResult doExecuteWithResult(
				...
				try {
					modelResource
							.save(EER.diagram.part.EERmodelDiagramEditorUtil
									.getSaveOptions());
					diagramResource
							.save(EER.diagram.part.EERmodelDiagramEditorUtil
									.getSaveOptions());
	...
	private static Project createInitialModel() {
		return EERFactory.eINSTANCE.createProject();
	}
