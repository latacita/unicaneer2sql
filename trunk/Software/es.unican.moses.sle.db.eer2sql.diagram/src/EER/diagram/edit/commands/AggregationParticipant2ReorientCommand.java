 ...
 * @generated
 */
public class AggregationParticipant2ReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public AggregationParticipant2ReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		MemberCollection container = (MemberCollection) getLink().eContainer();
		return EERmodelBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAggregationParticipant_4006(container, getLink(),
						getNewSource(), target);
	}
