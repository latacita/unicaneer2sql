...
public class EntityPrimaryKeyReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof CandidateKey && newEnd instanceof Entity)) {
			return false;
		}
		return Eer2sqlBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistEntityPrimaryKey_4014(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		if (!(oldEnd instanceof CandidateKey && newEnd instanceof CandidateKey)) {
			return false;
		}
		return Eer2sqlBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistEntityPrimaryKey_4014(getOldSource(), getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected CandidateKey getOldTarget() {
		return (CandidateKey) oldEnd;
	}

	/**
	 * @generated
	 */
	protected CandidateKey getNewTarget() {
		return (CandidateKey) newEnd;
	}
}
