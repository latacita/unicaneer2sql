...
public class InclusionReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		return Eer2sqlBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistInclusion_4011(getLink(), getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		return Eer2sqlBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistInclusion_4011(getLink(), source, getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getInclusionConstraints().remove(getLink());
		getNewSource().getInclusionConstraints().add(getLink());
