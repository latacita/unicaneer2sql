 ...
 * @generated
 */
public class InclusionCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public InclusionCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return EERmodelBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateInclusion_4008(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Inclusion newElement = EERFactory.eINSTANCE.createInclusion();
		getContainer().getInclusionConstraints().add(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(Inclusion newElement, IProgressMonitor monitor,
			IAdaptable info) throws ExecutionException {
