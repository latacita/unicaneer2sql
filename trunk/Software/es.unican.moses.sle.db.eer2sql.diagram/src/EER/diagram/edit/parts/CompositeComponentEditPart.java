...
import EER.diagram.edit.policies.CompositeComponentItemSemanticEditPolicy;
...
public class CompositeComponentEditPart extends ShapeNodeEditPart {
		...
		if (childEditPart instanceof CompositeComponentNameEditPart) {
			((CompositeComponentNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureCompositeComponentNameFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == Eer2sqlElementTypes.AggregationSource_4013) {
	...
	public List<IElementType> getMARelTypesOnTarget() {
		ArrayList<IElementType> types = new ArrayList<IElementType>(1);
		types.add(Eer2sqlElementTypes.AggregationParticipant_4009);
		return types;
	}
	...
	public List<IElementType> getMATypesForSource(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == Eer2sqlElementTypes.AggregationParticipant_4009) {
	...
	public class CompositeComponentFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureCompositeComponentNameFigure;
		...
		private void createContents() {
			...
			fFigureCompositeComponentNameFigure = new WrappingLabel();
			fFigureCompositeComponentNameFigure.setText("<...>");

			this.add(fFigureCompositeComponentNameFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureCompositeComponentNameFigure() {
			return fFigureCompositeComponentNameFigure;
		}
