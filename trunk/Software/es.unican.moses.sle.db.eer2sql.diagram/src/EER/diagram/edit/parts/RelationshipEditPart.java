...
public class RelationshipEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == Eer2sqlElementTypes.Exclusion_4002) {
		...
		} else if (relationshipType == Eer2sqlElementTypes.Inclusion_4011) {
			types.add(Eer2sqlElementTypes.Relationship_2008);
		}
		return types;
	}
