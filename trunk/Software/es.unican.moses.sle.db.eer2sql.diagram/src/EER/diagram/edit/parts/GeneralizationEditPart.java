...
public class GeneralizationEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public class GeneralizationFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureGeneralizationTypeFigure;
		...
		private void createContents() {
			...
			fFigureGeneralizationTypeFigure = new WrappingLabel();
			fFigureGeneralizationTypeFigure.setText("<...>");

			this.add(fFigureGeneralizationTypeFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureGeneralizationTypeFigure() {
			return fFigureGeneralizationTypeFigure;
		}
