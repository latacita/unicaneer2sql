...
import EER.diagram.edit.policies.PrimitiveTypeItemSemanticEditPolicy;
...
public class PrimitiveTypeEditPart extends ShapeNodeEditPart {
		...
		if (childEditPart instanceof PrimitiveTypeNameEditPart) {
			((PrimitiveTypeNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigurePrimitiveTypeNameFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMATypesForSource(IElementType relationshipType) {
		...
		if (relationshipType == Eer2sqlElementTypes.SingleAttribute_4004) {
	 ...
	 * @generated
	 */
	public class PrimitiveTypeFigure extends RectangleFigure {

		/**
		 * @generated
		 */
		private WrappingLabel fFigurePrimitiveTypeNameFigure;
		...
		private void createContents() {
			...
			fFigurePrimitiveTypeNameFigure = new WrappingLabel();
			fFigurePrimitiveTypeNameFigure.setText("<...>");

			this.add(fFigurePrimitiveTypeNameFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigurePrimitiveTypeNameFigure() {
			return fFigurePrimitiveTypeNameFigure;
		}
