...
public class EnumerationTypeEditPart extends ShapeNodeEditPart {
		...
		if (childEditPart instanceof EnumerationTypeNameEditPart) {
			((EnumerationTypeNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureEnumerationTypeNameFigure());
			return true;
		}
		return false;
	}
	 ...
	 * @generated
	 */
	public class EnumerationTypeFigure extends RectangleFigure {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureEnumerationTypeNameFigure;
		...
		private void createContents() {
			...
			fFigureEnumerationTypeNameFigure = new WrappingLabel();
			fFigureEnumerationTypeNameFigure.setText("<...>");

			this.add(fFigureEnumerationTypeNameFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureEnumerationTypeNameFigure() {
			return fFigureEnumerationTypeNameFigure;
		}
