...
public class EERmodelViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		return WeakEntityEditPart.VISUAL_ID == visualID
				...
				|| MemberCollectionEditPart.VISUAL_ID == visualID
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		case CompositeComponentEditPart.VISUAL_ID:
			return createCompositeComponent_2013(domainElement, containerView,
					index, persisted, preferencesHint);
		case MemberCollectionEditPart.VISUAL_ID:
			return createMemberCollection_2014(domainElement, containerView,
					index, persisted, preferencesHint);
		case PrimitiveTypeEditPart.VISUAL_ID:
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case AggregationParticipant2EditPart.VISUAL_ID:
			return createAggregationParticipant_4006(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
	 ...
	 * @generated
	 */
	public Node createCompositeComponent_2013(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createMemberCollection_2014(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Edge createAggregationParticipant_4006(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		...
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(EERmodelVisualIDRegistry
				.getType(AggregationParticipant2EditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
	...
	public Edge createParticipant_4001(EObject domainElement,
		...
		Node label6002 = createLabel(edge,
				EERmodelVisualIDRegistry
						.getType(ParticipantRole2EditPart.VISUAL_ID));
