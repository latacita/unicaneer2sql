...
public class EERmodelParserProvider extends AbstractProvider implements
	 ...
	 * @generated
	 */
	private IParser singleAttribute_3012Parser;

	/**
	 * @generated
	 */
	private IParser getSingleAttribute_3012Parser() {
		if (singleAttribute_3012Parser == null) {
			EAttribute[] features = new EAttribute[] { EERPackage.eINSTANCE
					.getAttribute_Name() };
			MessageFormatParser parser = new MessageFormatParser(features);
			singleAttribute_3012Parser = parser;
		}
		return singleAttribute_3012Parser;
	}
	 ...
	 * @generated
	 */
	private IParser singleAttribute_3013Parser;

	/**
	 * @generated
	 */
	private IParser getSingleAttribute_3013Parser() {
		if (singleAttribute_3013Parser == null) {
			EAttribute[] features = new EAttribute[] { EERPackage.eINSTANCE
					.getAttribute_Name() };
			MessageFormatParser parser = new MessageFormatParser(features);
			singleAttribute_3013Parser = parser;
		}
		return singleAttribute_3013Parser;
	}
	 ...
	 * @generated
	 */
	private IParser aggregationParticipantLowerBoundUpperBound_6004Parser;

	/**
	 * @generated
	 */
	private IParser getAggregationParticipantLowerBoundUpperBound_6004Parser() {
		if (aggregationParticipantLowerBoundUpperBound_6004Parser == null) {
			...
			aggregationParticipantLowerBoundUpperBound_6004Parser = parser;
		}
		return aggregationParticipantLowerBoundUpperBound_6004Parser;
	}
	...
	protected IParser getParser(int visualID) {
		...
		case SingleAttribute4EditPart.VISUAL_ID:
			return getSingleAttribute_3012Parser();
		...
		case SingleAttribute5EditPart.VISUAL_ID:
			return getSingleAttribute_3013Parser();
		...
		case AggregationParticipantLowerBoundUpperBoundEditPart.VISUAL_ID:
			return getAggregationParticipantLowerBoundUpperBound_6004Parser();
