 ...
 * @generated
 */
public abstract class EERmodelAbstractExpression {
	 ...
	 * @generated
	 */
	protected EERmodelAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
